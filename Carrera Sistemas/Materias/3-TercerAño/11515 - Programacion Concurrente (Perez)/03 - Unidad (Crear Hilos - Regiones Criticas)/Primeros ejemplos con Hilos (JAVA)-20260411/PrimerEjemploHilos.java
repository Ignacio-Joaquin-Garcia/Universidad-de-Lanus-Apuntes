...
public class PrimerEjemploHilos {

    // Contador compartido (región crítica)
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        MiHilo[] hilos = new MiHilo[nucleos]; ///arreglo de 4 hilos
        ...
        // 🔹 2. LANZAMIENTO
        for (int i = 0; i < nucleos; i++) {
            hilos[i].start(); ///Mis hilos contador++
        }
    ...
    public static void ejecutarConteo() {
        for (int i = 0; i < 10000; i++) {
            contador++; // 🔥 región crítica SIN protección
        }
    }
